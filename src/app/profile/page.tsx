...
const DEFAULT_COVER = 'linear-gradient(135deg, var(--brand) 0%, var(--brand-dark) 50%, #DC2626 100%)';
              ...
              {tabs.map((tab) => {
                ...
                return (
                  ...
                  >
                    ...
                    {tab.label} ({tab.count})
                    {activeTab === tab.key && (
                      <motion.div layoutId="profile-tab" className="absolute bottom-0 left-1/2 -translate-x-1/2 w-20 h-1 rounded-full" style={{ background: 'var(--brand)' }} />
                    )}
                  </button>
                );
              })}
